...
import { ArrowRight, CalendarCheck, Eye, EyeOff, Loader, Lock, ShieldCheck, Sparkles, Stethoscope, User } from 'lucide-react';
            ...
            <div className="input-group">
              ...
              <div className="input-icon-wrapper">
                ...
                <input
                  ...
                  className="input-field with-icon-and-toggle"
